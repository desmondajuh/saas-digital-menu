...
export default function EstablishmentView({ establishmentId }: Props) {
  ...
  async function handleRegenerateQR() {
    try {
      const newQR = await generateNewQRCode(establishmentId);
    ...
    <div className="space-y-8">
      <div>
        ...
        <div className="bg-card border rounded-lg p-6 space-y-4">
          ...
          <Link href={`/dashboard/establishments/${establishmentId}/settings`}>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href={`/dashboard/establishments/${establishmentId}/menus/new`}>
        ...
        {menus.length === 0 ? (
          <div className="text-center py-12 bg-card rounded-lg border">
            ...
            <Link
              href={`/dashboard/establishments/${establishmentId}/menus/new`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {menus.map((menu) => (
              <Link
                key={menu.id}
                href={`/dashboard/establishments/${establishmentId}/menus/${menu.id}`}
              >
      ...
      <div>
        ...
        <Link href={`/dashboard/establishments/${establishmentId}/orders`}>
